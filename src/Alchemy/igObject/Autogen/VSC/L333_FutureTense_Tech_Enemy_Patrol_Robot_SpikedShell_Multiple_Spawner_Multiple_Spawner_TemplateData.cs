namespace Alchemy
{
    ...
    public class L333_FutureTense_Tech_Enemy_Patrol_Robot_SpikedShell_Multiple_Spawner_Multiple_Spawner_TemplateData : CVscComponentData
    {
        ...
        [FieldAttr(64)] public igHandleMetaField _Multiple_Spawner_Templates003 = new();
        [FieldAttr(72)] public float _DelayBetweenEntities;
        [FieldAttr(80)] public igHandleMetaField _Multiple_Spawner_TemplateDatas_0x50 = new();
