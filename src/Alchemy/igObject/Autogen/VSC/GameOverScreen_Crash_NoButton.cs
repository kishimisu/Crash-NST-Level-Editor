namespace Alchemy
{
    // VSC object extracted from: GameOverScreen_Crash_NoButton_c.igz

    [ObjectAttr(64, metaType: typeof(igGuiVscBehavior))]
    public class GameOverScreen_Crash_NoButton : igGuiVscBehavior
    {
        [FieldAttr(40)] public igHandleMetaField _Zone_Info = new();
