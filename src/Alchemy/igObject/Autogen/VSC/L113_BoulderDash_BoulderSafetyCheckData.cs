namespace Alchemy
{
    // VSC object extracted from: L113_BoulderDash_BoulderSafetyCheck.igz

    [ObjectAttr(104, metaType: typeof(CVscComponentData))]
    public class L113_BoulderDash_BoulderSafetyCheckData : CVscComponentData
    {
        [FieldAttr(40)] public igHandleMetaField _Spline_Event_0x28 = new();
