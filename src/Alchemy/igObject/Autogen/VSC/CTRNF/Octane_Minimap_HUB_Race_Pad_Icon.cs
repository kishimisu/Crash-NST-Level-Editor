namespace Alchemy
{
    ...
    public class Octane_Minimap_HUB_Race_Pad_Icon : igGuiVscBehavior
    {
        ...
        [FieldAttr(nst: 96, ctr: 88)] public EZoneCollectibleType _E_Zone_Collectible_Type_0x58;
        [FieldAttr(nst: 104, ctr: 96)] public igHandleMetaField _Gui_Animation_Tag_0x60 = new();
        [FieldAttr(nst: 112, ctr: 104)] public bool _Bool;
        [FieldAttr(nst: 116, ctr: 108)] public int _Int;
        [FieldAttr(nst: 120, ctr: 112)] public igHandleMetaField _Entity = new();
        [FieldAttr(nst: 128, ctr: 120)] public EZoneCollectibleType _E_Zone_Collectible_Type_0x78;
        [FieldAttr(nst: 132, ctr: 124)] public EZoneCollectibleType _E_Zone_Collectible_Type_0x7c;
    }
}
