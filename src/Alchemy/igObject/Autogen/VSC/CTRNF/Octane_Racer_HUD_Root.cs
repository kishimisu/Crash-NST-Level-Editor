namespace Alchemy
{
    ...
    public class Octane_Racer_HUD_Root : igGuiVscBehavior
    {
        ...
        [FieldAttr(nst: 56, ctr: 48)] public EOctaneRaceModes _E_Octane_Race_Modes_0x30;
        [FieldAttr(nst: 64, ctr: 56)] public igHandleMetaField _Gui_Placeable_0x38 = new();
        [FieldAttr(nst: 72, ctr: 64)] public EOctaneRaceModes _E_Octane_Race_Modes_0x40;
        [FieldAttr(nst: 80, ctr: 72)] public igHandleMetaField _Gui_Animation_Tag = new();
    }
}
