namespace Alchemy
{
    ...
    public class T241_Assembly_Lane_GPI_Magnet_BoltKartData : CVscComponentData
    {
        ...
        [FieldAttr(nst: 88, ctr: 80)] public igHandleMetaField _Rumble_Data = new();
        [FieldAttr(nst: 96, ctr: 88)] public igHandleMetaField _Component_Data = new();
    }
}
