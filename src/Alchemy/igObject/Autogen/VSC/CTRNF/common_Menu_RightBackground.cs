namespace Alchemy
{
    [ObjectAttr(nst: 112, ctr: 104, align: 4, metaType: typeof(igGuiVscBehavior))]
    public class common_Menu_RightBackground : igGuiVscBehavior
    {
        ...
        [FieldAttr(nst: 64, ctr: 56)] public igVec4ucMetaField _Color = new();
