namespace Alchemy
{
    ...
    public class common_Air_Enemy_LabAssistantPilotData : CVscComponentData
    {
        ...
        [FieldAttr(nst: 64, ctr: 56)] public igHandleMetaField _Entity_Data = new();
        ...
        [FieldAttr(nst: 96, ctr: 88)] public igHandleMetaField _Debug_Update_Channel_0x60 = new();
        [FieldAttr(nst: 104, ctr: 96)] public igHandleMetaField _Entity_0x68 = new();
        [FieldAttr(nst: 112, ctr: 104)] public float _Float_0x70;
        [FieldAttr(nst: 120, ctr: 112)] public igHandleMetaField _Projectile_Spawn_Data = new();
        [FieldAttr(nst: 128, ctr: 120)] public igHandleMetaField _Entity_List = new();
        ...
        [FieldAttr(nst: 152, ctr: 144)] public igHandleMetaField _Entity_Tag = new();
        [FieldAttr(nst: 160, ctr: 152)] public igHandleMetaField _Debug_Update_Channel_0xa0 = new();
    }
}
