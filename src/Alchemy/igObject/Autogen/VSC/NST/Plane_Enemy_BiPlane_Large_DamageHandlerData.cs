namespace Alchemy
{
    ...
    public class Plane_Enemy_BiPlane_Large_DamageHandlerData : CVscComponentData
    {
        ...
        [FieldAttr(nst: 88, ctr: 80)] public igHandleMetaField _Entity_Tag_0x58 = new();
        ...
        [FieldAttr(nst: 112, ctr: 104)] public igHandleMetaField _Debug_Update_Channel = new();
        ...
        [FieldAttr(nst: 152, ctr: 144)] public igHandleMetaField _Damage_Data_0x98 = new();
        [FieldAttr(nst: 160, ctr: 152)] public igHandleMetaField _Damage_Data_0xa0 = new();
    }
}
