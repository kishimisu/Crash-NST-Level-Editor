namespace Alchemy
{
    ...
    public class common_RingOfPowerData : CVscComponentData
    {
        [FieldAttr(nst: 40, ctr: 32)] public igHandleMetaField _Vehicle_Boost_Data_0x28 = new();
        [FieldAttr(nst: 48, ctr: 40)] public igHandleMetaField _Vehicle_Boost_Data_0x30 = new();
        ...
        [FieldAttr(nst: 136, ctr: 128)] public igHandleMetaField _PlayerDied = new();
