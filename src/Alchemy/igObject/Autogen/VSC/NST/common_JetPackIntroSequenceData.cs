namespace Alchemy
{
    ...
    public class common_JetPackIntroSequenceData : CVscComponentData
    {
        [FieldAttr(nst: 40, ctr: 32)] public igHandleMetaField _Entity_0x28 = new();
        [FieldAttr(nst: 48, ctr: 40)] public igHandleMetaField _Jetpack_BehaviorState = new();
        ...
        [FieldAttr(nst: 160, ctr: 152)] public igHandleMetaField _Sound = new();
    }
}
