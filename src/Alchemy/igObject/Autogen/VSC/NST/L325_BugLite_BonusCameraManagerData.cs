namespace Alchemy
{
    ...
    public class L325_BugLite_BonusCameraManagerData : CVscComponentData
    {
        [FieldAttr(nst: 40, ctr: 32)] public igHandleMetaField _Camera_Box_List_0x28 = new();
        ...
        [FieldAttr(nst: 64, ctr: 56)] public igHandleMetaField _Camera_Box_List_0x40 = new();
