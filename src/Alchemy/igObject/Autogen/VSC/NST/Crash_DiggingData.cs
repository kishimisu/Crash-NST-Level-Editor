namespace Alchemy
{
    ...
    public class Crash_DiggingData : CVscComponentData
    {
        [FieldAttr(nst: 40, ctr: 32)] public igHandleMetaField _Entity_Data = new();
        [FieldAttr(nst: 48, ctr: 40)] public igHandleMetaField _Collision_Material = new();
        [FieldAttr(nst: 56, ctr: 48)] public igHandleMetaField _Shape_0x38 = new();
        [FieldAttr(nst: 64, ctr: 56)] public igHandleMetaField _Shape_0x40 = new();
        ...
        [FieldAttr(nst: 112, ctr: 104)] public igHandleMetaField _Behavior_State_Group = new();
