namespace Alchemy
{
    ...
    public class Castle_OrbitComplex_DowelControllerData : CVscComponentData
    {
        ...
        [FieldAttr(nst: 64, ctr: 56)] public igVec3fMetaField _Vec_3F_0x40 = new();
        ...
        [FieldAttr(nst: 104, ctr: 96)] public igVec3fMetaField _Vec_3F_0x68 = new();
