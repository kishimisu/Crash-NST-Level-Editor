namespace Alchemy
{
    ...
    public class C2_HubTalkingHeadsLevelManagerData : CVscComponentData
    {
        [FieldAttr(nst: 40, ctr: 32)] public igHandleMetaField _Camera_0x28 = new();
        [FieldAttr(nst: 48, ctr: 40)] public igHandleMetaField _Camera_0x30 = new();
        ...
        [FieldAttr(nst: 96, ctr: 88)] public igHandleMetaField _Game_Bool_Variable = new();
        ...
        [FieldAttr(nst: 136, ctr: 128)] public igHandleMetaField _Zone_Info_0x88 = new();
        ...
        [FieldAttr(nst: 176, ctr: 168)] public igHandleMetaField _Waypoint_0xb0 = new();
        [FieldAttr(nst: 184, ctr: 176)] public igHandleMetaField _Waypoint_0xb8 = new();
        ...
        [FieldAttr(nst: 208, ctr: 200)] public igHandleMetaField _Waypoint_0xd0 = new();
