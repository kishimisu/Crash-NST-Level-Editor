namespace Alchemy
{
    ...
    public class L207_AirCrash_Platform_Mover_Spawner_DeathRouteData : CVscComponentData
    {
        [FieldAttr(nst: 40, ctr: 32)] public igHandleMetaField _Entity = new();
        [FieldAttr(nst: 48, ctr: 40)] public igHandleMetaField _Spline_Event_0x30 = new();
        [FieldAttr(nst: 56, ctr: 48)] public igHandleMetaField _Spline_Event_0x38 = new();
