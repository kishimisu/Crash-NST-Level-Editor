namespace Alchemy
{
    ...
    public class common_Crate_SlotMachine_SpawnedData : CVscComponentData
    {
        ...
        [FieldAttr(nst: 50, ctr: 42)] public bool _Bool_0x32;
        [FieldAttr(nst: 51, ctr: 43)] public bool _Bool_0x33;
        ...
        [FieldAttr(nst: 120, ctr: 112)] public igHandleMetaField _Game_Bool_Variable = new();
