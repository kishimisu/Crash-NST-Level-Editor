namespace Alchemy
{
    ...
    public class BossNGin_C2Mech_FakeCollisionHelperData : CVscComponentData
    {
        ...
        [FieldAttr(nst: 136, ctr: 128)] public igHandleMetaField _Entity_0x88 = new();
        [FieldAttr(nst: 144, ctr: 136)] public igHandleMetaField _Bolt_Point_0x90 = new();
        [FieldAttr(nst: 152, ctr: 144)] public igHandleMetaField _Entity_0x98 = new();
        ...
        [FieldAttr(nst: 176, ctr: 168)] public igHandleMetaField _Behavior_State_Group_0xb0 = new();
        [FieldAttr(nst: 184, ctr: 176)] public igHandleMetaField _Bolt_Point_0xb8 = new();
        [FieldAttr(nst: 192, ctr: 184)] public igHandleMetaField _Waypoint_0xc0 = new();
        [FieldAttr(nst: 200, ctr: 192)] public igHandleMetaField _Waypoint_0xc8 = new();
        [FieldAttr(nst: 208, ctr: 200)] public igHandleMetaField _Vfx_Effect = new();
        [FieldAttr(nst: 216, ctr: 208)] public float _Float;
        [FieldAttr(nst: 224, ctr: 216)] public igHandleMetaField _Entity_0xe0 = new();
        [FieldAttr(nst: 232, ctr: 224)] public igHandleMetaField _Bolt_Point_0xe8 = new();
        [FieldAttr(nst: 240, ctr: 232)] public igHandleMetaField _Behavior_State_Group_0xf0 = new();
    }
}
