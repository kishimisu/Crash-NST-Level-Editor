namespace Alchemy
{
    ...
    public class Crash_BoulderData : CVscComponentData
    {
        ...
        [FieldAttr(nst: 104, ctr: 96)] public igHandleMetaField _Behavior_State_Group_0x68 = new();
        ...
        [FieldAttr(nst: 192, ctr: 184)] public igHandleMetaField _Entity_Tag_0xc0 = new();
        [FieldAttr(nst: 200, ctr: 192)] public igHandleMetaField _Zone_Info_0xc8 = new();
        [FieldAttr(nst: 208, ctr: 200)] public igHandleMetaField _Game_Float_Variable = new();
    }
}
