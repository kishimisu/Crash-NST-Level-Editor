namespace Alchemy
{
    ...
    public class L219_Ruination_BonusCameraManagerData : CVscComponentData
    {
        [FieldAttr(nst: 40, ctr: 32)] public igHandleMetaField _Entity_List = new();
        [FieldAttr(nst: 48, ctr: 40)] public igHandleMetaField _Camera_Box_List_0x30 = new();
        ...
        [FieldAttr(nst: 72, ctr: 64)] public igHandleMetaField _Camera_Box_List_0x48 = new();
    }
}
