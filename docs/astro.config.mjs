	...
	integrations: [
		starlight({
			...
			social: [
				...
				// { icon: 'discord', label: 'Discord', href: 'https://discord.gg/vsnVrPvVjc' },
			],
			editLink: DOCS_REPO_URL ? { baseUrl: `${DOCS_REPO_URL.replace(/\/+$/, '')}/edit/main/` } : undefined,
			lastUpdated: true,
			customCss: ['./src/styles/custom.css'],
			sidebar: [
				{ label: 'Get Started', items: [{ autogenerate: { directory: 'get-started' } }] },
				// { label: 'Play Custom Levels', items: [{ autogenerate: { directory: 'play' } }] },
				{
					label: 'Level Editor',
					items: [
						...
						'level-editor/save-play-and-backups',
