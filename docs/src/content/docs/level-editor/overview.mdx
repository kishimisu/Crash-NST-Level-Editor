...
- **Copy and paste across levels.** <kbd>Ctrl</kbd>+<kbd>C</kbd> / <kbd>Ctrl</kbd>+<kbd>V</kbd> works from one level editor to another, including from CTR:NF levels. See [Copy, paste and undo](/level-editor/copy-paste-and-undo/).
