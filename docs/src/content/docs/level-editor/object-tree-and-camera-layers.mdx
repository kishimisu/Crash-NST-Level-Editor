...
| Group | Contents |
| --- | --- |
| **Lighting** | Light sources and visual boxes. See [Visual boxes and skybox](/level-editor/special-objects/visual-boxes-and-skybox/) and [Lights](/level-editor/special-objects/lights/). |
| **VFX** | Visual effects. |
| **SFX** | Sound effects and music. See [Music and audio](/level-editor/special-components/music-and-audio/). |
| **Other** | Every other entity without a model, such as the `WorldInstance` and the level border collisions. |
