...
<kbd>Ctrl</kbd>+<kbd>Z</kbd> undoes selection, move, rotate and scale actions. <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>Z</kbd> redoes them. Other actions cannot be undone yet, see [Copy, paste and undo](/level-editor/copy-paste-and-undo/#undo-and-redo).
