...
- **Play Custom Level** launches the game directly into a custom level or hub. See [Play a custom level](/play/play-a-custom-level/).
...
:::note
A level is also an archive! You can open a level either in the Level Editor or the Archive Editor, so the same level may appear in both panels.
:::

## Manage active mods (right panel)

This is the [Mod Manager](/play/mod-manager/): add mods, apply them to the game, revert them, and launch the game at any level, including the main menu, bosses and debug levels.
