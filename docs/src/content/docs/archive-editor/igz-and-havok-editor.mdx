...
| Entry | Effect |
| --- | --- |
| **Copy name** | Copies the object's type and name to the clipboard. |
| **Copy object** | Copies the object. |
| **Paste object** | Adds a new object from the clipboard. Objects can be pasted into another file or another archive; their dependencies are imported automatically. |
...
- Click on **Navigation arrows** go back and forward through the objects you visited.
...
- Not all editing features are available in Havok files.
